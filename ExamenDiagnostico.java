...
public class inicioPAM
{
    ...
    private static void PorcentajesParciales()
    {
        ...
        JOptionPane.showMessageDialog(null,"EVIDENCIA DE CONOCIMIENTO 40% 40% 20%", "SEGUNDO PARCIAL");
        JOptionPane.showMessageDialog(null,"EVIDENCIA DE CONOCIMIENTO 40% 40% 20%", "TERCER PARCIAL");


        JOptionPane.showMessageDialog(null,"EVIDENCIA DE CONOCIMIENTO 40% 40% 20%", "PRIMER PARCIAL");
        JOptionPane.showMessageDialog(null,"EVIDENCIA DE DESEMPEÑO 20% 20% 10%");
        JOptionPane.showMessageDialog(null,"EVIDENCIA DE PRODUCTO 30% 20% 40%");
        JOptionPane.showMessageDialog(null,"PROYECTO INTEGRADOR 10% 20% 30%");
    }
    ...
    public static void main(String[] args)
    {
        ...
        Opcion = JOptionPane.showInputDialog(null, 
                                            "¡Bienvenido!\n
                                            Este programa es un diagnóstico para saber cuánto sabemos de POO.",
                                            "PAM");
        do
        {
            switch (Opcion) 
